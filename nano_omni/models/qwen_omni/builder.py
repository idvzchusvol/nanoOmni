...
from nano_omni.models.registry import register_family
...
@register_family("qwen3_omni")
def build_qwen3_omni_pipeline(cfg: PipelineConfig, device: str = "cuda") -> Pipeline:
...
@register_family("qwen25_omni")
def build_qwen25_omni_pipeline(cfg: PipelineConfig, device: str = "cuda") -> Pipeline:
